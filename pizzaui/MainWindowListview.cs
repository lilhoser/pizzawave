...
namespace pizzaui
{
    public partial class MainWindow
    {
        ...
        private void transcriptionListview_CellToolTipShowing(object sender, BrightIdeasSoftware.ToolTipShowingEventArgs e)
        {
            ...
            var transcribedCall = e.Model as TranscribedCall;
            if (transcribedCall == null || string.IsNullOrEmpty(transcribedCall.Transcription))
            {
                return;
            }
        ...
        private void InitializeButtonColumn()
        {
            ...
            {
                var row = e.Model as TranscribedCall;
                if (row == null)
                {
                    return;
                }
                ...
                {
                    MessageBox.Show("No audio file associated with this call");
                    return;
                }
        ...
        {
            var tag = Sender as ToolStripMenuItem;
            if (tag == null)
            {
                return;
            }
            var clickArgs = tag.Tag as CellRightClickEventArgs;
            if (clickArgs == null)
            {
                return;
            }
            var listview = clickArgs.ListView;
            if (listview == null)
            {
                return;
            }
            ...
            )
        {
            ...
            var targetCell = clickArgs.ColumnIndex;
            var listview = clickArgs.ListView as FastObjectListView;
            if (listview == null)
            {
                return;
            }
            ...
            )
        {
            ...
            if (call == null || string.IsNullOrEmpty(call.Location))
            {
                return;
            }
