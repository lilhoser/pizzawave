...
For those that are new to SDRs, I thought it might be helpful to show how I setup my SDR array: <P> <img align="center" src="http://github.com/lilhoser/pizzawave/raw/main/docs/rtlsdr-setup.png">
