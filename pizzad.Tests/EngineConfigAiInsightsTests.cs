...
public sealed class EngineConfigAiInsightsTests
{
    ...
    public void ApplyDefaults_KeepsIncidentV2ShadowDisabledUnlessConfigured()
    {
        var config = new EngineConfig
        {
            AiInsights = new AiInsightsConfig
            {
                ...
                IncidentParticipantLinkWindowSeconds = 10_000,
        ...
        Assert.False(config.AiInsights.IncidentParticipantLinkCandidateEnabled);
        Assert.Equal(3600, config.AiInsights.IncidentParticipantLinkWindowSeconds);
        ...
        Assert.False(config.AiInsights.IncidentBatchRollingHypothesisEnabled);
    ...
    [Fact]
    public void ApplyDefaults_CompactIntakeForcesExhaustiveIsolatedBatchedVerification()
    {
        var config = new EngineConfig
        {
            AiInsights = new AiInsightsConfig
            {
                IncidentBatchExhaustiveBatchedIntakeEnabled = true
            }
        };
        ...
        Assert.True(config.AiInsights.IncidentBatchConstructorShadowObservationIsolated);
        Assert.True(config.AiInsights.IncidentBatchConstructorShadowSourceIsolated);
        Assert.True(config.AiInsights.IncidentBatchBatchedStandaloneVerificationEnabled);
    }

    [Fact]
    public void ApplyDefaults_RollingHypothesisDisablesRetiredMultiPassContracts()
    {
        var config = new EngineConfig
        {
            AiInsights = new AiInsightsConfig
            {
                IncidentBatchRollingHypothesisEnabled = true,
                IncidentBatchExhaustiveBatchedIntakeEnabled = true,
                IncidentBatchBatchedStandaloneVerificationEnabled = true,
                IncidentBatchRelationshipShadowEnabled = true,
        ...
        Assert.True(config.AiInsights.IncidentBatchRollingHypothesisEnabled);
        Assert.False(config.AiInsights.IncidentBatchExhaustiveBatchedIntakeEnabled);
        Assert.False(config.AiInsights.IncidentBatchBatchedStandaloneVerificationEnabled);
        Assert.False(config.AiInsights.IncidentBatchRelationshipShadowEnabled);
        Assert.False(config.AiInsights.IncidentBatchVerificationShadowEnabled);
        Assert.False(config.AiInsights.IncidentBatchConstructorShadowObservationIsolated);
        Assert.False(config.AiInsights.IncidentBatchConstructorShadowSourceIsolated);
        Assert.Equal(20, config.AiInsights.IncidentBatchConstructorShadowBatchSize);
        Assert.Equal(20, config.AiInsights.IncidentBatchConstructorShadowMinimumBatchSize);
        Assert.Equal(600, config.AiInsights.IncidentBatchConstructorShadowMaximumWaitSeconds);
        Assert.Equal(4, config.AiInsights.IncidentBatchConstructorShadowCandidateLimit);
        Assert.True(config.AiInsights.IncidentBatchConstructorShadowContinuous);
    }
