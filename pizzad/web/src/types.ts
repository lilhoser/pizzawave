...
export type IncidentBatchShadowAttempt = { sequence: number; recordedAtUtc: string; firstCallId: number; lastCallId: number; newObservationCount: number; candidateCount: number; proposedEventCount: number; newEventCount: number; confirmedMembershipCount: number; provisionalAssociationCount: number; unresolvedObservationCount: number; modelIdentity: string; eventTitles: string[]; validationErrors: string[]; proposerMilliseconds: number; proposerError: string };
