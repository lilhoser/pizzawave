...
export type IncidentBatchShadowAttempt = { sequence: number; recordedAtUtc: string; firstCallId: number; lastCallId: number; newObservationCount: number; candidateCount: number; proposedEventCount: number; acceptedEventCount: number; rejectedEventCount: number; newEventCount: number; provisionalEventCount: number; confirmedMembershipCount: number; provisionalAssociationCount: number; unresolvedObservationCount: number; modelIdentity: string; promptIdentity: string; configurationIdentity: string; eventTitles: string[]; validationErrors: string[]; proposerMilliseconds: number; proposerError: string };
