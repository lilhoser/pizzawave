...
export type IncidentBatchVerificationTotals = { enqueued: number; pending: number; verified: number; rejected: number; invalid: number; canaryPersisted: number; canaryConflicts: number; averageVerifierMilliseconds: number; maximumVerifierMilliseconds: number };
